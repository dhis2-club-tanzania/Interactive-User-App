...
export class UserService {
  ...
  getData(): Observable<any> {
    return this.http.get(
      "users.json?fields=id,displayName,userCredentials[username,disabled,userRoles[id,name],lastLogin,invitation,selfRegistered],organisationUnits,userGroups[id,name]&paging=false"
    );
  }
